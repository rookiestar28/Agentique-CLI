...
Published in this repository for direct workflow usage and on npm; registry readback currently records the published package set at `0.2.2`. GitHub Marketplace-style promotion remains a separate future channel.
