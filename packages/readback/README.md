...
This package helps integrators consume public Agentique resource status from `agentique.io` when the platform exposes versioned public endpoints. It exposes status, list, detail, download metadata, and readback projection helpers only.
