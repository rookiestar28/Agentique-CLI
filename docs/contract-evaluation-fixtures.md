...
Additional schema fixture coverage also includes parser/variant states, agent-native preparation/readback states, portable profile generated-adapter metadata, graph/block bundle metadata, block manifests, diagnostic ledgers, workspace artifact metadata, API drift metadata, and generated block fixture manifests.
